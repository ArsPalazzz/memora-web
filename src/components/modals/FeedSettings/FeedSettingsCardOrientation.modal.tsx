...
import { FeedSettingsCardOrientationModalProps } from "./FeedSettings.types";
...
export default function FeedSettingsCardOrientationModal(
  props: FeedSettingsCardOrientationModalProps
) {
